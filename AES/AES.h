...
public:
    ...
    void EncryptECB(const std::string& inputName, std::vector<unsigned char> key, const std::string& outputName);
    void EncryptECB(bitmap_image* imageIN, std::vector<unsigned char> key, bitmap_image* imageOUT);
    void EncryptOFB(const std::string& inputName, std::vector<unsigned char> key, const std::string& outputName, std::vector<unsigned char> iv);
    void EncryptOFB(bitmap_image* imageIN, std::vector<unsigned char> key, bitmap_image* imageOUT, std::vector<unsigned char> iv);
    void DecryptECB(const std::string& inputName, std::vector<unsigned char> key, const std::string& outputName);
    void DecryptECB(bitmap_image* imageIN, std::vector<unsigned char> key, bitmap_image* imageOUT);
    void DecryptOFB(const std::string& inputName, std::vector<unsigned char> key, const std::string& outputName, std::vector<unsigned char> iv);
    void DecryptOFB(bitmap_image* imageIN, std::vector<unsigned char> key, bitmap_image* imageOUT, std::vector<unsigned char> iv);
    ...
    std::vector<unsigned char> EncryptVector(std::vector<unsigned char> in, std::vector<unsigned char> key);
    std::vector<unsigned char> DecryptVector(std::vector<unsigned char> in, std::vector<unsigned char> key);
    std::vector<unsigned char> EncryptOFB(std::vector<unsigned char> in, std::vector<unsigned char> key, std::vector<unsigned char> iv);
    std::vector<unsigned char> DecryptOFB(std::vector<unsigned char> in, std::vector<unsigned char> key, std::vector<unsigned char> iv);


    std::vector<unsigned char> EncryptVectorOFB(std::vector<unsigned char> in, std::vector<unsigned char> key, std::vector<unsigned char> iv);
    std::vector<unsigned char> DecryptVectorOFB(std::vector<unsigned char> in, std::vector<unsigned char> key, std::vector<unsigned char> iv);
};
